        ...
        <div class="layout-wrapper">
            ...
            <aside class="sidebar fade-in">
                <ul class="sidebar-menu">
                    ...
                    <li style="border-top: 1px solid var(--border-color); margin-top: 8px; padding-top: 8px;">
                        <asp:Button ID="btnAddLeague" CssClass="sidebar-btn active" runat="server" Text="&#xf1ae; Add League" OnClick="btnAddLeague_Click" Style="font-family: 'Raleway', 'Font Awesome 5 Free'; font-weight: 600;" />
                    </li>
                    <li>
            ...
            <main class="main-content fade-in" style="animation-delay: 0.2s;">
                <div class="container-fluid">
                    <h1 class="page-title">League Catalog</h1>
                    <p class="text-muted mb-4">Register the football leagues available in the system (e.g., LaLiga, Premier League).</p>
                        ...
                        <div class="col-xl-6 col-lg-8">
                            <div class="form-card">
                                ...
                                <div class="form-group">
                                    <label>League Name <span class="text-danger">*</span></label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        <asp:Button ID="btnSaveLeague" runat="server"
                                            Text="&#xf0c7; Save League"
                                            CssClass="mybtn"
                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <h3 class="text-white mb-4" style="font-weight: 600;">
                                <i class="fas fa-list mr-2"></i>Registered Leagues
                            </h3>
                            <div class="table-responsive">
                                <asp:GridView ID="gvLeagues" runat="server"
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="Id_League" HeaderText="ID" />
                                        <asp:BoundField DataField="Name_League" HeaderText="League Name" />
                                        <asp:TemplateField HeaderText="Actions">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbDeleteLeague" runat="server"
                                                    CommandName="Delete"
                                                    CssClass="btn btn-sm btn-danger"
                                                    OnClientClick="return confirm('Are you sure you want to delete this league? All associated teams will be deleted as well.');"
