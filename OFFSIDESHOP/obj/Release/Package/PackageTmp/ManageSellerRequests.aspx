...
<head runat="server">
    ...
    <style>
        ...
        .modal-body p, .modal-body div, .modal-body span, .modal-body label, .modal-body small {
            text-align: left !important;
        }
                            ...
                            <asp:Panel ID="pnlReviews" runat="server" Visible="false">
                                <div class="table-responsive">
                                    <asp:GridView ID="gvReviews" runat="server"
                                        ...
                                        EmptyDataText="<%$ Resources:Strings, Admin_Seller_EmptyReviews %>">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:Strings, Admin_Seller_ColUser %>">
                                                <ItemTemplate>
                                                    <span class="font-weight-bold"><%# Eval("UserName") %> <%# Eval("UserLastName") %></span><br />
                                                    <small class="text-muted"><%# Eval("UserEmail") %></small>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="ShirtName" HeaderText="<%$ Resources:Strings, Admin_Seller_ColProduct %>" ItemStyle-Font-Bold="true" />
                                            ...
                                            <asp:TemplateField HeaderText="<%$ Resources:Strings, Review_CommentLabel %>" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="250px">
                                                <ItemTemplate>
                                                    <div style="max-height: 80px; overflow-y: auto; font-style: normal; text-align: left; font-size: 0.9rem;">
                                                        "<%# Eval("Comment") %>"
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="<%$ Resources:Strings, Review_OfficialReply %>" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="200px">
                                                <ItemTemplate>
                                                    <div style="max-height: 80px; overflow-y: auto; font-size: 0.85rem; text-align: left; color: #17a2b8;">
                    ...
                    <div class="modal-backdrop-custom">
                        <div class="modal-dialog-custom">
                            <div class="modal-header bg-dark text-white px-4 py-3 d-flex justify-content-between align-items-center">
                                ...
                                <asp:LinkButton ID="btnCloseX" runat="server" OnClick="btnCloseModal_Click" CssClass="close-btn-corner" title="Close">&times;</asp:LinkButton>
                            </div>
                            <div class="modal-body p-4" style="color: var(--text-main) !important; background-color: var(--bg-card) !important; max-height: 70vh; overflow-y: auto;">
                                ...
                                <div class="row mb-3 border-bottom pb-2 text-left" style="border-color: var(--border-color) !important; text-align: left;">
                                    <div class="col-6 text-left" style="text-align: left;">
                                        <small class="text-muted d-block text-uppercase font-weight-bold text-left" style="text-align: left;">
                                            <asp:Literal runat="server" Text="<%$ Resources:Strings, Admin_Seller_ColEmail %>" /></small>
                                        <span class="font-weight-bold text-left d-block" style="color: var(--text-main) !important; text-align: left;">
                                ...
                                <div class="mb-3 text-left" style="text-align: left;">
                                    <small class="text-muted d-block text-uppercase font-weight-bold text-left" style="text-align: left;">
                                        <asp:Literal runat="server" Text="<%$ Resources:Strings, Admin_Seller_ColSubject %>" /></small>
                                    <h6 class="font-weight-bold text-left" style="font-size: 1.1rem; color: var(--text-main) !important; text-align: left;">
                                        <asp:Literal ID="litModalSubject" runat="server" /></h6>
                                </div>

                                <div class="mb-3 user-message-box">
                                    <small>
                                        <asp:Literal runat="server" Text="<%$ Resources:Strings, Admin_Seller_ModalMessage %>" /></small>
                                    <div class="user-message-content">
                                        <asp:Literal ID="litModalMessage" runat="server" />
                                    </div>
                                </div>

                                <!-- Dynamic conditional content: Order Issues -->
                                <asp:Panel ID="pnlModalOrder" runat="server" Visible="false" Style="background: var(--bg-panel); border: 1px solid var(--border-color) !important; color: var(--text-main) !important;" class="mb-3 p-3 rounded text-left">
                                    <h6 class="text-info font-weight-bold mb-2 text-left" style="text-align: left;"><i class="fas fa-shopping-bag mr-2"></i>
                                        <asp:Literal runat="server" Text="<%$ Resources:Strings, Admin_Seller_ModalLinkedOrder %>" /></h6>
                                    <p class="mb-0 text-left" style="color: var(--text-main) !important; text-align: left;">
                                        <strong>
                                ...
                                <div class="form-group mt-3 text-left" style="text-align: left;">
                                    <label for="txtAdminNotes" class="font-weight-bold text-uppercase small text-muted text-left" style="text-align: left;">
                                        <asp:Literal runat="server" Text="<%$ Resources:Strings, Admin_Seller_ModalAdminResponse %>" /></label>
                                    <asp:TextBox ID="txtAdminNotes" runat="server" TextMode="MultiLine" Rows="4" CssClass="form-control text-left" placeholder="<%$ Resources:Strings, Placeholder_AdminNotes %>" />
                                </div>

                                <asp:Label ID="lblModalError" runat="server" CssClass="alert alert-danger d-block mt-3 font-weight-bold small text-left" Visible="false" style="text-align: left;" />
                            </div>
                            <div class="modal-footer px-4 py-3 d-flex justify-content-between" style="background: var(--bg-card) !important; border-top: 1px solid var(--border-color) !important;">
                                <asp:Button ID="btnCancel" runat="server" Text="<%$ Resources:Strings, Admin_Seller_ModalClose %>" CssClass="btn btn-secondary font-weight-bold" OnClick="btnCloseModal_Click" />
                                <div>
                                    <asp:Button ID="btnReject" runat="server" Text="<%$ Resources:Strings, Admin_Seller_ModalReject %>" CssClass="btn btn-danger font-weight-bold mr-2" OnClick="btnReject_Click" />
                                    <asp:Button ID="btnApprove" runat="server" Text="<%$ Resources:Strings, Admin_Seller_ModalApprove %>" CssClass="btn btn-success font-weight-bold" OnClick="btnApprove_Click" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-backdrop-custom">
                        <div class="modal-dialog-custom">
                            <div class="modal-header bg-dark text-white px-4 py-3 d-flex justify-content-between align-items-center">
                                ...
                                <asp:LinkButton ID="btnCloseReplyModal" runat="server" OnClick="btnCloseReplyModal_Click" CssClass="close-btn-corner" title="Close">&times;</asp:LinkButton>
                            </div>
                            <div class="modal-body p-4" style="color: var(--text-main) !important; background-color: var(--bg-card) !important; text-align: left !important;">
                                <div class="mb-3 user-message-box">
                                    <small>
                                        <asp:Literal runat="server" Text="<%$ Resources:Strings, Admin_Seller_ReviewModalOriginal %>" /></small>
                                    <div class="user-message-content">
                                        <asp:Literal ID="litOriginalReview" runat="server" />
                                    </div>
                                </div>
