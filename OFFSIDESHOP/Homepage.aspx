    ...
    <style>
        * {
        ...
        .search-header-section {
            ...
            padding-bottom: 30px;
            border-bottom: 3px solid #FFC800; /* Detalle premium en oro */
        ...
        .search-input-group {
            ...
            .search-input-group .input-group-text {
                border: none;
                font-size: 0.95rem;
                color: #FFC800; /* Lupa oro elegante */
                padding-left: 15px;
            }
        ...
        /* Local Overrides for Bootstrap Classes */
        .text-danger {
        ...
        /* Slick Slider overrides to display beautifully */
        ...
        /* Asegurar que el contenedor permita posicionamiento absoluto interno */
        .products-slick {
            position: relative;
            display: block;
            width: 100%;
        ...
        /* Estilos blindados para tus flechas personalizadas de OFFSIDESHOP */
        .offside-prev, .offside-next {
            ...
            border: 2px solid #FFC800 !important; /* Borde Dorado */
            border-radius: 50% !important;
            color: #FFC800 !important; /* Icono Dorado */
            ...
            box-shadow: 0px 4px 15px rgba(0, 0, 0, 0.5) !important; /* Sombra para resaltar */
        ...
        /* Posicionamiento seguro en los extremos (metidas 10px hacia adentro para evitar recortes) */
        .offside-prev {
            left: 10px !important;
        }
        ...
        .scroll-to-top,
        .scrolltop,
        a[href="#page-top"]:not(.navbar-brand) {
            display: none !important;
        }
        ...
        .sidebar-check-group .form-check {
            ...
            .sidebar-check-group .form-check input[type="checkbox"] {
                width: 16px;
                height: 16px;
                margin: 0;
                accent-color: #FFC800;
            ...
            .sidebar-check-group .form-check label {
                margin: 0;
                font-size: 0.85rem;
                cursor: pointer;
                color: #333;
        ...
        /* Fix ASP.NET CheckBoxList rendered with Flow layout */
        .sidebar-sizes-container {
            display: flex;
            flex-wrap: wrap;
            gap: 12px;
            align-items: center;
            ...
            .sidebar-sizes-container span {
                display: flex;
                align-items: center;
                gap: 4px;
            }

            .sidebar-sizes-container label {
                margin: 0;
                font-size: 0.85rem;
                color: #333;
                cursor: pointer;
            ...
            .sidebar-sizes-container input[type="checkbox"] {
                width: 15px;
                height: 15px;
                margin: 0;
                accent-color: #FFC800;
        ...
        /* Fix ASP.NET CheckBox rendering for sale/custom checkboxes */
        .sidebar-check-single {
            display: flex;
            align-items: center;
            gap: 8px;
            padding: 6px 0;
            ...
            .sidebar-check-single input[type="checkbox"] {
                width: 16px;
                height: 16px;
                margin: 0;
                accent-color: #FFC800;
        ...
        .category-pills .cat-pill.active, .category-pills .cat-pill:hover {
            background: #1a1a1a;
            color: #FFC800;
            border-color: #1a1a1a;
        }
        ...
        .collection-card:hover {
            transform: translateY(-5px);
            box-shadow: 0 10px 20px rgba(255, 200, 0, 0.2) !important;
            border-color: #FFC800;
        }
        .collection-overlay {
            position: absolute;
        ...
        .collection-btn:hover { background: #FFC800; color: #000000; transform: scale(1.05); }
...
<body id="page-top">
    ...
    <div class="navbar-icons-container">
        ...
        <asp:PlaceHolder ID="phLeaguesSection" runat="server" Visible="true">
            <div class="container mb-5" style="margin-top: 25px !important;">

                <div class="d-block d-lg-none mb-3 text-center">
                    <button type="button" class="btn btn-dark w-100 fw-bold py-2 shadow-sm text-uppercase"
                        data-bs-toggle="collapse"
                ...
                <div class="collapse d-lg-block" id="leaguesPanelCollapse">
                    <div class="row row-cols-2 row-cols-md-3 row-cols-lg-6 g-4 justify-content-center text-center">

                        <div class="col">
                            <a href="Homepage.aspx?league=1" class="text-decoration-none text-dark league-card-link">
                                <div class="card h-100 border-0 shadow-sm p-4 bg-white league-card" style="border-radius: 16px; transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1);">
                                    <img src="assets/img/leagues/laliga.png" alt="LaLiga" class="img-fluid mx-auto mb-2 league-logo" style="max-height: 85px; object-fit: contain; transition: transform 0.3s ease;" />
                                </div>
                            </a>
                        </div>

                        <div class="col">
                            <a href="Homepage.aspx?league=2" class="text-decoration-none text-dark league-card-link">
                                <div class="card h-100 border-0 shadow-sm p-4 bg-white league-card" style="border-radius: 16px; transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1);">
                                    <img src="assets/img/leagues/premierleague.webp" alt="Premier League" class="img-fluid mx-auto mb-2 league-logo" style="max-height: 85px; object-fit: contain; transition: transform 0.3s ease;" />
                                </div>
                            </a>
                        </div>

                        <div class="col">
                            <a href="Homepage.aspx?league=4" class="text-decoration-none text-dark league-card-link">
                                <div class="card h-100 border-0 shadow-sm p-4 bg-white league-card" style="border-radius: 16px; transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1);">
                                    <img src="assets/img/leagues/bundesliga.png" alt="Bundesliga" class="img-fluid mx-auto mb-2 league-logo" style="max-height: 85px; object-fit: contain; transition: transform 0.3s ease;" />
                                </div>
                            </a>
                        </div>

                        <div class="col">
                            <a href="Homepage.aspx?league=3" class="text-decoration-none text-dark league-card-link">
                                <div class="card h-100 border-0 shadow-sm p-4 bg-white league-card" style="border-radius: 16px; transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1);">
                                    <img src="assets/img/leagues/seriea.png" alt="Serie A" class="img-fluid mx-auto mb-2 league-logo" style="max-height: 85px; object-fit: contain; transition: transform 0.3s ease;" />
                                </div>
                            </a>
                        </div>

                        <div class="col">
                            <a href="Homepage.aspx?league=5" class="text-decoration-none text-dark league-card-link">
                                <div class="card h-100 border-0 shadow-sm p-4 bg-white league-card" style="border-radius: 16px; transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1);">
                                    <img src="assets/img/leagues/ligueone.png" alt="Ligue 1" class="img-fluid mx-auto mb-2 league-logo" style="max-height: 85px; object-fit: contain; transition: transform 0.3s ease;" />
                                </div>
                            </a>
                        </div>

                        <div class="col">
                            <a href="Homepage.aspx?league=7" class="text-decoration-none text-dark league-card-link">
                                <div class="card h-100 border-0 shadow-sm p-4 bg-white league-card" style="border-radius: 16px; transition: all 0.3s cubic-bezier(0.25, 0.8, 0.25, 1);">
                                    <img src="assets/img/leagues/mls.png" alt="MLS" class="img-fluid mx-auto mb-2 league-logo" style="max-height: 85px; object-fit: contain; transition: transform 0.3s ease;" />
                                </div>
                            </a>
                        </div>
        ...
        <style>
            ...
            .league-card-link:hover .league-logo {
                transform: scale(1.1);
            }
        </style>
        <%-- COLLECTIONS SECTION --%>
        <asp:PlaceHolder ID="phCollectionsSection" runat="server" Visible="false">
            <div class="container mt-5 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="collections-slick" id="collections-slick">
                            <asp:Repeater ID="rptCollections" runat="server">
                                <ItemTemplate>
                                    <div class="collection-slide" data-category='<%# Eval("Id_Category") %>'>
                                        <div class="collection-card shadow-sm" style='background-image: url("<%# GetCollectionImage(Eval("ImageURL").ToString()) %>");'>
        ...
        <asp:PlaceHolder ID="phSectionsView" runat="server" Visible="true">
            ...
            <div class="container my-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="products-slick" id="wc-slick">
                            <asp:Repeater ID="rptWC" runat="server">
                                <ItemTemplate>
                                    <div class="card h-100 text-dark product-card">
                                        <div class="position-absolute top-0 start-0 m-2 d-flex flex-column gap-1" style="z-index: 5;">
                                            <%# Convert.ToBoolean(Eval("IsOnSale")) ? "<span class='badge bg-danger text-uppercase fw-bold shadow-sm px-2 py-1' style='font-size:0.65rem;'><i class='fas fa-percentage me-1'></i>SALE -" + Eval("DiscountPercentage") + "%</span>" : "" %>
            ...
            <div class="container my-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="products-slick" id="laliga-slick">
                            <asp:Repeater ID="rptLaLiga" runat="server">
                                <ItemTemplate>
                                    <div class="card h-100 text-dark product-card">
                                        <div class="position-absolute top-0 start-0 m-2 d-flex flex-column gap-1" style="z-index: 5;">
                                            <%# Convert.ToBoolean(Eval("IsOnSale")) ? "<span class='badge bg-danger text-uppercase fw-bold shadow-sm px-2 py-1' style='font-size:0.65rem;'><i class='fas fa-percentage me-1'></i>SALE -" + Eval("DiscountPercentage") + "%</span>" : "" %>
            ...
            <div class="container my-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="products-slick" id="premier-slick">
                            <asp:Repeater ID="rptPremier" runat="server">
                                <ItemTemplate>
                                    <div class="card h-100 text-dark product-card">
                                        <div class="position-absolute top-0 start-0 m-2 d-flex flex-column gap-1" style="z-index: 5;">
                                            <%# Convert.ToBoolean(Eval("IsOnSale")) ? "<span class='badge bg-danger text-uppercase fw-bold shadow-sm px-2 py-1' style='font-size:0.65rem;'><i class='fas fa-percentage me-1'></i>SALE -" + Eval("DiscountPercentage") + "%</span>" : "" %>
            ...
            <div class="container my-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="products-slick" id="seriea-slick">
                            <asp:Repeater ID="rptSerieA" runat="server">
                                <ItemTemplate>
                                    <div class="card h-100 text-dark product-card">
                                        <div class="position-absolute top-0 start-0 m-2 d-flex flex-column gap-1" style="z-index: 5;">
                                            <%# Convert.ToBoolean(Eval("IsOnSale")) ? "<span class='badge bg-danger text-uppercase fw-bold shadow-sm px-2 py-1' style='font-size:0.65rem;'><i class='fas fa-percentage me-1'></i>SALE -" + Eval("DiscountPercentage") + "%</span>" : "" %>
            ...
            <div class="container my-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="products-slick" id="bundesliga-slick">
                            <asp:Repeater ID="rptBundesliga" runat="server">
                                <ItemTemplate>
                                    <div class="card h-100 text-dark product-card">
                                        <div class="position-absolute top-0 start-0 m-2 d-flex flex-column gap-1" style="z-index: 5;">
                                            <%# Convert.ToBoolean(Eval("IsOnSale")) ? "<span class='badge bg-danger text-uppercase fw-bold shadow-sm px-2 py-1' style='font-size:0.65rem;'><i class='fas fa-percentage me-1'></i>SALE -" + Eval("DiscountPercentage") + "%</span>" : "" %>
            ...
            <div class="container my-5">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="products-slick" id="ligueone-slick">
                            <asp:Repeater ID="rptLigueOne" runat="server">
                                <ItemTemplate>
                                    <div class="card h-100 text-dark product-card">
                                        <div class="position-absolute top-0 start-0 m-2 d-flex flex-column gap-1" style="z-index: 5;">
                                            <%# Convert.ToBoolean(Eval("IsOnSale")) ? "<span class='badge bg-danger text-uppercase fw-bold shadow-sm px-2 py-1' style='font-size:0.65rem;'><i class='fas fa-percentage me-1'></i>SALE -" + Eval("DiscountPercentage") + "%</span>" : "" %>
        ...
        <%-- SEARCH RESULTS VIEW --%>
        <asp:PlaceHolder ID="phSearchResultsView" runat="server" Visible="false">
            <div class="container my-5">
                <h2 class="text-center text-dark mb-4 pb-2 border-bottom border-warning border-3" style="font-weight: 700;">
                    <asp:Label ID="lblSearchTerm" runat="server" Text="Search results"></asp:Label>
                </h2>
            </div>


            <asp:UpdatePanel ID="upSearchArea" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                                ...
                                <div class="card border-0 shadow-sm p-4 bg-white" style="border-radius: 12px; position: sticky; top: 20px; z-index: 10;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <asp:DropDownList ID="ddlSidePriceRange" runat="server" CssClass="form-select form-select-sm">
                                            ...
                                            <asp:ListItem Text="$50 to $100" Value="50-100"></asp:ListItem>
                                            <asp:ListItem Text="$100 to $150" Value="100-150"></asp:ListItem>
                                            <asp:ListItem Text="Over $150" Value="150-9999"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                            ...
                                            <div class="col">
                                                <div class="card h-100 text-dark product-card border-0 shadow-sm position-relative overflow-hidden" style="border-radius: 8px;">
                                                    ...
                                                    <div class="bg-light d-flex align-items-center justify-content-center text-center p-2" style="height: 200px; overflow: hidden;">
                                                        <img src='<%# Eval("ImageURL") != DBNull.Value && !string.IsNullOrEmpty(Eval("ImageURL").ToString()) ? Eval("ImageURL") : "assets/img/default-product.jpg" %>'
                                                             class="img-fluid" alt='<%# FormatJerseyName(Eval("Name")) %>' style="max-height: 100%; object-fit: contain;"
                                                    ...
                                                    <div class="card-body d-flex flex-column justify-content-between p-3 bg-white">
                                                        <div>
                                                            <span class="text-uppercase text-muted fw-bold d-block mb-1" style="font-size: 0.7rem; letter-spacing: 0.5px;">
                                                                <%# Eval("Brand") %> | <%# Eval("Year") %>
                                                            </span>
                                                            <h6 class="fw-bold text-dark text-truncate-2 mb-2" style="font-size: 0.85rem; min-height: 36px; line-height: 1.3;" title='<%# FormatJerseyName(Eval("Name")) %>'>
        ...
        <!-- LABELS DE CONTROL OCULTOS (Para que no generen espacios negros en la grilla) -->
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            // SLIDERS DE CAMISETAS (Tu codigo actual se mantiene intacto)
            var slickCarousels = ['#top-selling-slick', '#new-arrivals-slick', '#wc-slick', '#laliga-slick', '#premier-slick', '#seriea-slick', '#bundesliga-slick', '#ligueone-slick'];

            slickCarousels.forEach(function (id) {
                var $target = $(id);
                if ($target.length && $target.children().length > 0) {
                    var totalCamisetas = $target.children().length;
                    $target.slick({
                        dots: false, infinite: false, slidesToShow: 4, slidesToScroll: 1, arrows: (totalCamisetas > 4),
                        prevArrow: '<button type="button" class="offside-prev">&#10094;</button>',
                        nextArrow: '<button type="button" class="offside-next">&#10095;</button>',
                        responsive: [
                            { breakpoint: 1024, settings: { slidesToShow: 3, arrows: (totalCamisetas > 3) } },
                            { breakpoint: 768, settings: { slidesToShow: 1, arrows: (totalCamisetas > 1) } }
                        ]
                    });
                }
            });

            // SLIDER DE COLECCIONES Y FILTRADO POR BOTONES
            var $colSlick = $('#collections-slick');
            if ($colSlick.length && $colSlick.children().length > 0) {

                $colSlick.slick({
                    dots: false, infinite: false, slidesToShow: 3, slidesToScroll: 1, arrows: true,
                    prevArrow: '<button type="button" class="offside-prev">&#10094;</button>',
                    nextArrow: '<button type="button" class="offside-next">&#10095;</button>',
                    responsive: [
                ...
                $('.cat-pill').click(function () {
                    ...
                    $colSlick.slick('slickUnfilter'); // Limpiar filtros previos

                    if (filterCat !== 'all') {
                        $colSlick.slick('slickFilter', function () {
                            return $(this).attr('data-category') == filterCat;
                        });
                    }
                });
            }
